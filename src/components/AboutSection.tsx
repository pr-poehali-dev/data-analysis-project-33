...
const stats = [
  ...
  { number: "50+", label: "Созданных логотипов" },
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Мы — команда разработчиков и дизайнеров, которая создаёт сайты под любую задачу: продвижение услуг, продажи, привлечение клиентов. Работаем с бизнесом любого масштаба.
          </p>
        </div>
